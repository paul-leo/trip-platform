...
A reusable development environment for Symphony aspects.  
Use the Symphony environment to create new Symphony aspects, platforms and runtimes.
...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "nore-work.trip/envs/symphony-env"
    ]
  }
}
```
...
```
bit env set my-component nore-work.trip/envs/symphony-env
```


## Create a Symphony workspace

You can create a new NodeJS workspace made from this env using the following command:

```
bit new symphony-platform my-workspace --aspect nore-work.trip/envs/symphony-env
```
...
```
bit create harmony-env my-new-env
```
